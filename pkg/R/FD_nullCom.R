...
#'
#' @examples View(data1) # original dataframe, it is not a functional diversity dataframe
#'
#' @examples FD_nullcom(data1, nNull= 10, type= "all", call.nullsummary = FALSE, plot.null = FALSE)) # Note: in this case it doesn't summarise nor plot the data.
#'
#'
#'
