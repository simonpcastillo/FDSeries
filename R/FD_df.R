...
#'         and the corresponding estimation of abundance or biomass for each time bin.
...
#' @examples View(data0) #internal dataset
#'
#' @examples data1 <- Fd_df(df=data3char)
#'
#' @examples View(data1) #functional diversity dataframe
#'
#'
#'
